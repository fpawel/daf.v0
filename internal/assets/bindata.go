...
func assetsExeManifest() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/6408.exe.manifest", size: 738, mode: os.FileMode(438), modTime: time.Unix(1518413152, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"assets/6408.exe.manifest":   assetsExeManifest,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"assets": &bintree{nil, map[string]*bintree{
		"6408.exe.manifest": &bintree{assetsExeManifest, map[string]*bintree{}},
